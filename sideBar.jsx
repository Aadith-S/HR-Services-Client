    ...
    return (
        <div style={sidebar}>
            <ul className="sidebar">
                <center><b><h4>EMPLOYEE DASHBOARD</h4></b></center>
...
export function HR_Sidebar() {
    return (
        <div style={sidebar}>
            <ul className="sidebar">
                <center><b><h4>HR DASHBOARD</h4></b></center>
                ...
                <li><a href="viewAllFeedback"className="tag"><span></span><span>View Feedback</span></a></li>
            </ul>
            </div>
    );
}
